   ...
   * */
    fun gano(player: Ficha): Boolean {
        var win  = false
            ...
            else if(celdas[1][0]?.estadoCelda==player && celdas[1][1]?.estadoCelda==player && celdas[1][2]?.estadoCelda==player){
                win = true
            }
            else if(celdas[2][0]?.estadoCelda==player && celdas[2][1]?.estadoCelda==player && celdas[2][2]?.estadoCelda==player){
                win = true
            }
            else if(celdas[0][0]?.estadoCelda==player && celdas[1][0]?.estadoCelda==player && celdas[2][0]?.estadoCelda==player){
                win = true
            }
            else if(celdas[0][1]?.estadoCelda==player && celdas[1][1]?.estadoCelda==player && celdas[2][1]?.estadoCelda==player){
                win = true
            }
            else if(celdas[0][2]?.estadoCelda==player && celdas[1][2]?.estadoCelda==player && celdas[2][2]?.estadoCelda==player){
                win = true
            }
            else if(celdas[0][0]?.estadoCelda==player && celdas[1][1]?.estadoCelda==player && celdas[2][2]?.estadoCelda==player){
                win = true
            }
            else if(celdas[2][0]?.estadoCelda==player && celdas[1][1]?.estadoCelda==player && celdas[0][2]?.estadoCelda==player){
                win = true
            }
...
* */
    fun setTablero( p1: ArrayList<Int>,  p2: ArrayList<Int>){
        ...
        for(x in p1){
            setFicha(x, Ficha.CRUZ)
        }
        for(x in p2){
            setFicha(x, Ficha.BOLA)
        }
            ...
            siguientesMovimientos.forEach {
                ...
                if (jugador == miFicha){
                    ...
                    * */
                    ...
                    println("calificacion actual1: $calificacionActual")
                    ...
                    * */
                    ...
                    println("calificacion actual2: $calificacionActual")
